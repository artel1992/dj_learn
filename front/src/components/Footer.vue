        ...
        <el-col :span="24">
            ...
            <el-row type="flex" justify="center">
                <el-col :lg="6" align="center" class="mb-3">
                    <img src="../assets/Photo/SocialIcons.png" alt="" width="320" height="60">
<!--                    <span class="social-icon-plus" style="color: #f00075">i</span>-->
<!--                    <span class="social-icon" style="color: #d6492f">g</span>-->
<!--                    <span class="social-icon si-f">f</span>-->
